...
public class RemoveCarrosConverterTest {
	...
	@Autowired
	private AtualizaCarrosConverter flow;
	...
	public void testConvertSuccess() {
		ResponseEntity<ResponsePutCarros> response = flow.execute(CarroBuilder.createEntityCarro());
		assertNotNull(response);
		assertEquals(HttpStatus.OK, response.getStatusCode());

		ResponsePutCarros body = response.getBody();
		assertNotNull(body);
